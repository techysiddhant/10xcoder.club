      ...
      <div className="container px-6">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-lg text-muted-foreground mb-8 max-w-xl mx-auto leading-relaxed">
            This platform is shaped by developers who build real products — and want better starting
            points. No paywalls, no fluff, just quality resources.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button variant="outline" size="lg" className="h-12 px-6 font-semibold">
              Start Contributing
            </Button>
          </div>
        </div>
