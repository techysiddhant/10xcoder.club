      ...
      <div className="fixed top-0 left-0 right-0 z-60 w-full border-b border-amber-500/20 bg-amber-50 dark:bg-amber-950/98 min-h-13 sm:min-h-12 flex items-center backdrop-blur-sm">
        <div className="container mx-auto px-3 sm:px-6 py-2  w-full">
          <div className="flex flex-col sm:flex-row flex-wrap items-center justify-center gap-2 text-center sm:text-left w-full">
            <span className="text-xs sm:text-sm text-amber-800 dark:text-amber-200 leading-snug">
            ...
            <a
              ...
              className="inline-flex items-center justify-center text-xs sm:text-sm font-medium text-amber-800 dark:text-amber-200 underline underline-offset-2 hover:text-amber-600 dark:hover:text-amber-400 focus:outline-none focus:ring-2 focus:ring-amber-500/50 rounded min-h-9 w-full sm:w-auto py-2 px-3 touch-manipulation"
            >
              Report issues
            </a>
          </div>
