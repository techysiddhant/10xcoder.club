...
// Enums
export const languageEnum = pgEnum('language', ['english', 'hindi'])
export const resourceStatusEnum = pgEnum('resource_status', ['approved', 'rejected', 'pending'])
...
export const resource = pgTable(
  'resource',
  {
    ...
    // Categorization (FK to resource_type.name)
    resourceType: text('resource_type')
      .notNull()
      .references(() => resourceType.name),
